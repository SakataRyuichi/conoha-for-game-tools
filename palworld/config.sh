...
declare -r SERVER_DIR="/opt/palworld"
...
function check_conoha_for_game() {
    if [ ! -d "$SERVER_DIR" ]; then
        die "This server is not a Palworld Server built on ConoHa for GAME."
    fi
}
...
function main_menu() {
    echo "Palworld Server Configutation Tool for 'ConoHa for GAME'"
